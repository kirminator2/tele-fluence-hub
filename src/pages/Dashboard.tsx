      ...
      <div className="border-b border-border bg-card/50 backdrop-blur-sm">
        <div className="flex h-16 items-center justify-between px-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Добро пожаловать в TeleAffiliates</p>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-border bg-card p-6">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-lg font-semibold">Доход за неделю</h3>
              <span className="text-sm text-muted-foreground">$37,610 всего</span>
            </div>
            <Chart
              data={revenueData}
              type="bar"
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-lg font-semibold">Конверсия по часам</h3>
              <span className="text-sm text-muted-foreground">Средний CR: 3.9%</span>
            </div>
            <Chart
              data={conversionData}
              type="line"
        ...
        <div className="rounded-xl border border-border bg-card">
          <div className="flex items-center justify-between border-b border-border p-6">
            <div>
              <h3 className="text-lg font-semibold">Топ офферы</h3>
              <p className="text-sm text-muted-foreground">Лучшие результаты за сегодня</p>
            </div>
            <Button variant="outline" size="sm">
              Все офферы
